...
Config.Webhook = 'https://discord.com/api/webhooks/1025330221316046928/-q_wLt9oh1_tXNDxFpgzs0GJd_PLGXxAYWeQeVMM8lf3qxNno9ATVRLg4ISOhhlteLjF'

-- Item name for pings app ( Having a VPN sends an anonymous ping, else sends the players name)
Config.VPNItem = 'pixellaptops'
